export const config = {
  "mapTitle": "Broadband internet coverage in the EU", // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
  "vercelURL": "https://map-broadband-internet-coverage.vercel.app/", // The url provided when deploying the map on Vercel
